        ...
        <div className="w-full bg-white py-16 px-4">
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
                ...
                <div className="flex flex-col jusitfy-center">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Itaque, sapiente vel tenetur, ab impedit, ex saepe quo officia excepturi illum fugiat esse vero? Molestiae dolorem, vel vitae quisquam veniam accusantium.</p>
