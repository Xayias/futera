        ...
        <div className="w-full pb-[5rem] pt-[5rem] px-8 bg-white">
            <div className="max-w-[1000px] mx-auto grid md:grid-cols-3 gap-8">
                <div className="w-full border-2 border-[#1bb8d7] bg-gray-300 shadow-xl flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
                    ...
                    <h2 className="text-2xl font-bold text-center py-8">Networking Services</h2>
                    <p className="text-center text-lg font-bold px-1">Delivering seamless, high-speed connectivity to power your business operations.</p>
                    <div className="text-center font-medium">
                        <p className='py-2 border-b border-gray-500 mx-8 mt-8'>High-Speed Connectivity</p>
                        <p className='py-2 border-b border-gray-500 mx-8'>Reliable Network Infrastructure</p>
                        <p className='py-2 mx-8'>Optimized Bandwidth for Peak Performance</p>
                ...
                <div className="w-full border-2 border-[#1bb8d7] shadow-xl flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300">
                    ...
                    <p className="text-center text-lg font-bold px-1">Empowering businesses with AI-driven insights and predictive analytics</p>
                    <div className="text-center font-medium">
                        <p className='py-2 border-b border-gray-500 mx-8 mt-8'>AI-Driven Predictive Models</p>
                        <p className='py-2 border-b border-gray-500 mx-8'>Automated Data Processing</p>
                        <p className='py-2 mx-8'>Customized ML Solutions for Your Business</p>
                ...
                <div className="w-full border-2 border-[#1bb8d7] bg-gray-300 shadow-xl flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
                    ...
                    <h2 className="text-2xl font-bold text-center py-8">Data Security</h2>
                    <p className="text-center text-lg font-bold px-1">Comprehensive data protection for peace of mind and compliance</p>
                    <div className="text-center font-medium">
                        <p className='py-2 border-b border-gray-500 mx-8 mt-8'>End-to-End Encryption</p>
                        <p className='py-2 border-b border-gray-500 mx-8'>Threat Detection & Prevention</p>
                        <p className='py-2 mx-8'>Compliance with Industry Standards</p>
